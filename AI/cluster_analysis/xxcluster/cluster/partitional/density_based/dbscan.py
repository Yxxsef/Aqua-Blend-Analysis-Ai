...
Xu (ref_36), because the definitions the method rests on -- core point,
...
class DBSCAN(BaseDensityClusterer):
    ...
    _capabilities = Capabilities(
        ...
        references=("ref_36", "ref_37", "ref_18", "ref_1"),
    ...
    def _extract_clusters(self, X: MatrixLike, density: ArrayLike) -> None:
        ...
        The three definitions of ref_36, in order: a core point is one
