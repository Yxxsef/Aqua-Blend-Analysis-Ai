...
%  REFERENCES USED
%
%    ref_9    Peng et al. (2025), curse of dimensionality           cited in: Limitations
%    ref_10   Tan et al. (2019), Introduction to Data Mining, ch. 7 cited in: Overview, Definition, Behaviour
%    ref_11   Han et al. (2011), Data Mining, ch. 10                cited in: Overview, Definition, Behaviour
%    ref_17   Guo et al. (2024), daily consumption patterns         cited in: Overview, Behaviour
%
%  MISSING --- the original source is not in literature.bib and cannot
%  be cited: Rousseeuw (1987), "Silhouettes: a graphical aid to the
%  interpretation and validation of cluster analysis".  See the \todo
%  in `Definition'.  Raised with the document lead.
% ==================================================================
