...
For each cluster, the Davies--Bouldin Index computes the ratio of within-cluster scatter to the distance between cluster centroids and then averages the worst-case ratio across all clusters. Formally, \cite{ref_28}
