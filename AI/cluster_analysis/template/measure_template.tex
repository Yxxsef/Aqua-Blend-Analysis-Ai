...
%    a validity index --->
%      cp template/measure_template.tex \
%         documentation/sections/clustering_methods/validity/NN-<name>.tex
%
%  Then: replace <NAME>, replace the label suffix `template' with the
%  measure's short name, and add one \input line in cluster_main.tex ---
%  under Section 7.1 for a dissimilarity, Section 7.2 for an index.
%
%  This file is NOT included in the build.
%
%  Levels: a measure is a \subsubsection under Section 7.1 or 7.2, so the
%  parts below are \paragraph.  Keep their order unchanged in every copy.
%
%  Code counterpart:
